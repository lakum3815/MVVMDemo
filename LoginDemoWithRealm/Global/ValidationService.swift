...
//  Samyda Parent
//
//  Created by Pritesh Patel on 11/08/18.
...
//        var str  = hexString
//        
//        if str.characters.count == 0 || str .isEqual(string: "")  {
//            str = "#000000"
//        }
//     
//        var rgbValue : uint = 0
...
//        
//        return UIColor(red: CGFloat(((rgbValue & 0xFF0000) >> 16) / 255), green: CGFloat(((rgbValue & 0xFF00) >> 8) / 255), blue: CGFloat((rgbValue & 0xFF) / 255), alpha: CGFloat(1.0))
//    }
}
