...
- (void)setButtonBackgroundColor:(UIColor *)buttonBackgroundColor
{
    ...
    if (buttonBackgroundColor != nil) {
        ...
        _buttonBackgroundColor = [[UIColor alloc] initWithRed:0 green:122.0f/255.0f blue:1 alpha:1];
    }
    if (_cancelButtonTitle != nil) {
        UIButton *cancelButton = (UIButton *)[self viewWithTag:_cancelButtonIndex + 1];
        [cancelButton setBackgroundColor:buttonBackgroundColor];
    }
...
- (UIButton *)setButtonWithTitle:(NSString *)buttonTitle
{
    ...
    _buttonBackgroundColor = [UIColor colorWithRed:254.0/255.0 green:196.0/255.0 blue:107.0/255.0 alpha:1.0];
